...
echo "deb [arch=arm64 signed-by=/etc/apt/keyrings/1password-archive-keyring.gpg] \
...
sudo apt update
sudo apt install --yes 1password-cli

cd ~/Downloads
wget -nv https://downloads.1password.com/linux/tar/stable/aarch64/1password-latest.tar.gz
